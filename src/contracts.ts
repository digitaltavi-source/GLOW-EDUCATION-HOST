...
export const LearningRequest = z.object({
  ...
  operation: z.enum(["create_learning_experience","get_work","submit_work","inspect_blocked_stage","approve_stage","get_status","get_delivery","continue_learning_experience"]),
